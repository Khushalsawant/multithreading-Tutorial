# -*- coding: utf-8 -*-
"""
Created on Wed Aug  7 07:21:18 2019
...
'''
to determine in a local network which addresses are active or which computers are active,
this script can be used. But you have to be careful with the range,
because it can jam the network, if too many pings are started at once.
...
for suffix in range(20,30):
    # give the IP of server which you want to pin
